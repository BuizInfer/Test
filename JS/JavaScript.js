...
let canvasCount = 0; // Contador para llevar un seguimiento del número de canvas renderizados
window.loadSTL = function () {
    ...
    if (selectedFile) {
        ...
        loader.load(URL.createObjectURL(selectedFile), (model) => {
            ...
            container.style.top = `${165 + canvasCount * 230}px`;
            ...
            newRenderer.domElement.style.top = `${125 + canvasCount * 230}px`;
    ...
    tableDiv.style.top = `${125 + canvasCount * 230}px`;
    ...
    tableDiv.style.justifyContent = 'center';
        ...
        tableDiv1.style.top = `${100 + canvasCount * 230}px`;
